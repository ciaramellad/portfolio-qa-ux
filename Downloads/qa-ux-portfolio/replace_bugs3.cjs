...
const bugsEs = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Identificar bloques de texto en mayúsculas",
      "Localizar : etiquetas de categorías del menú, títulos de secciones promocionales, CTAs secundarios",
  ...
  },
  {
    ...
    steps: [
      ...
      "Verificar si tienen atributo alt con descripción o alt"
    ],
    expected: "Imágenes informativas (destinos, banners con información): deben tener alt descriptivo (ej: alt='Vista aérea de Roma, destino disponible').",
    actual: "Axe DevTools detecta imágenes de destinos sin atributo alt o con alt que contiene el nombre del archivo (ej: alt='img_rome_hero_v2.jpg').",
    evidence: null
  },
  {
    id: "BUG-010",
    ...
    steps: [
      "Abrir ryanair.com/es/es en Chrom",
      "Ejecutar: SEO META extension de Chrome",
      "Verificar: ¿hay más de 1 H1?"
    ],
    expected: "Cada página debe tener exactamente 1 elemento H1 que describa el contenido principal. La jerarquía debe ser continua y lógica: H1 → H2 → H3, sin saltos de nivel.",
    actual: "La home de Ryanair contiene múltiples elementos H1 (se detectan al menos 3 en la misma página). Se encuentran saltos directos de H1 a H3 sin H2 intermedio en la sección de ofertas. Algunas secciones usan H4 directamente",
...
console.log('Bugs 8, 9, 10 successfully modified!');
