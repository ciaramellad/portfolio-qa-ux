        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4 flex flex-col justify-end">
            <div className={`p-8 rounded-3xl border ${theme === 'dark' ? 'border-white/10 bg-white/5' : 'border-[#121212]/10 bg-black/5'}`}>
              <p className="text-[14px] uppercase tracking-widest opacity-50 mb-4">Location</p>
              <p className="text-lg font-medium">Buenos Aires, Argentina</p>
              <div className="h-8" />
              <p className="text-[14px] uppercase tracking-widest opacity-50 mb-4">Experience</p>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-8">
                  <div className="space-y-4 max-w-2xl">
                    <div className="flex items-center gap-3">
                      <span className="text-[14px] font-mono opacity-50">0{i + 1}</span>
              ...
              <div key={i} className="group space-y-6">
                <div className="aspect-[4/3] overflow-hidden rounded-[2rem] bg-neutral-100 relative">
                  ...
                  <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                    <button className="bg-white text-black px-8 py-3 rounded-full font-bold tracking-widest uppercase text-[14px]">
                      {t.view}
                    </button>
                  </div>
                </div>
