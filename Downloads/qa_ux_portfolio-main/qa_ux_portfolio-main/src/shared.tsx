  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw() {
        ...
        ctx.fillStyle = theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(18, 18, 18, 0.7)';
        ctx.fill();
      }
    }
...
export const translations = {
  en: {
    ...
    daily_app: {
      title: "DAILY – Personal Finance App",
      subtitle: "Personal financial management application designed to track expenses and income across multiple bank accounts. The project is used as a Manual QA study case, performing functional and usability testing in a real-use environment.",
      ...
      testCasesTable: [
        ...
        },
        {
          ...
          details: {
            ...
            evidence: {
              response: "/img/img-saucedemo/TC-002-login-error.png"
            }
          }
        },
        {
        ...
        },
        {
          ...
          details: {
            ...
            evidence: {
              response: "/img/img-saucedemo/TC-004-detalle.png"
            }
          }
        },
        {
        ...
        },
        {
          ...
          details: {
            ...
            evidence: {
              response: "/img/img-saucedemo/TC-006-multiples-productos.png"
            }
          }
        },
        {
        ...
        },
        {
          ...
          details: {
            ...
            evidence: {
              response: "/img/img-saucedemo/TC-009-checkout-valido.png"
            }
          }
        },
        {
          ...
          details: {
            ...
            evidence: {
              response: "/img/img-saucedemo/TC-010-checkout-error.png"
            }
          }
        }
      ],
      ...
      bugsList: [
        {
          ...
          evidence: "/img/img-saucedemo/BUG-001.png"
        },
        {
          id: "BUG-002",
          testCaseId: "TC-003",
          ...
          evidence: "/img/img-saucedemo/BUG-002.png"
        },
        {
          id: "BUG-003",
          ...
          evidence: "/img/img-saucedemo/BUG-003.png"
        },
        {
          id: "BUG-004",
          testCaseId: "TC-003",
          ...
          evidence: "/img/img-saucedemo/BUG-004.mp4"
        }
      ],
      uxImprovements: [
    ...
    ux_audit: {
      ...
      bugs: [
        ...
        },
        {
          ...
          evidence: "/img/img-ryanair/BUG-002-modal-login-home.mp4"
        }
      ],
  ...
  es: {
    ...
    daily_app: {
      title: "DAILY – Personal Finance App",
      subtitle: "Aplicación personal de gestión financiera diseñada para controlar gastos e ingresos en múltiples cuentas bancarias. El proyecto se utiliza como caso de estudio de QA Manual, realizando pruebas funcionales y de usabilidad en un entorno real de uso.",
